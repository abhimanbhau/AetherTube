...
import com.abhimankolte.aethertube.common.presenters.settings.AetherTubeSettingsPresenter;
import com.abhimankolte.aethertube.common.presenters.settings.LegacySettingsPresenter;
...
public class AppDataSourceManager {
    ...
    public List<SettingsItem> getSettingItems(Context context) {
        ...
        settingItems.add(new SettingsItem(
                "AetherTube", () -> AetherTubeSettingsPresenter.instance(context).show(), R.drawable.settings_main_ui));
        settingItems.add(new SettingsItem(
        ...
        settingItems.add(new SettingsItem(
                context.getString(R.string.settings_legacy), () -> LegacySettingsPresenter.instance(context).show(), R.drawable.settings_app));
