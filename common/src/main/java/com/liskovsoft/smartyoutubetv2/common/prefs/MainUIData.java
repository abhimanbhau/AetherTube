...
public class MainUIData extends DataChangeBase implements ProfileChangeListener {
    ...
    private boolean mIsNewUiEnabled;
    ...
    public boolean isNewUiEnabled() {
        return mIsNewUiEnabled;
    }

    public void setNewUiEnabled(boolean enable) {
        mIsNewUiEnabled = enable;
        persistState();
    }
    ...
    private void persistStateInt() {
        mPrefs.setProfileData(MAIN_UI_DATA, Helpers.mergeData(null,
                ...
                mIsUnlocalizedTitlesEnabled, mUiTweaks, mIsNewUiEnabled));
    }
