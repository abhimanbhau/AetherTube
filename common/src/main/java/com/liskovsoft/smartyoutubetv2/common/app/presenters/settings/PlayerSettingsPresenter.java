...
public class PlayerSettingsPresenter extends BasePresenter<Void> {
    ...
    /**
     * Per-button OSD visibility, playback-engine internals (network engine / buffer / pixel ratio),
     * the misc grab-bag, and device/firmware compatibility fixes. All real settings - the compat
     * fixes especially matter to users on hardware this fork doesn't personally test against - just
     * not things most people ever touch. See {@link LegacySettingsPresenter}.
     */
