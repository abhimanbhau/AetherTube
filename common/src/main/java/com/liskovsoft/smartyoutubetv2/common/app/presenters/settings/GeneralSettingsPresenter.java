...
public class GeneralSettingsPresenter extends BasePresenter<Void> {
    ...
    /**
     * Context menu item visibility/ordering, per-section "hide content" variants, key remapping,
     * and fine-grained screen dimming - real settings, just not ones most people customize
     * item-by-item. See {@link LegacySettingsPresenter}.
     */
