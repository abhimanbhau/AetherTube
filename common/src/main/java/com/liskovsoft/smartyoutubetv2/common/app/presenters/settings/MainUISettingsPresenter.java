...
public class MainUISettingsPresenter extends BasePresenter<Void> {
    ...
    /**
     * Leanback-card cosmetic fine-tuning and clock/fullscreen display toggles - real settings,
     * just not ones most people ever touch. See {@link LegacySettingsPresenter}.
     */
    public void showLegacy() {
        ...
        appendLegacyMiscCategory(settingsPresenter);
    ...
    private void appendLegacyMiscCategory(AppDialogPresenter settingsPresenter) {
        List<OptionItem> options = new ArrayList<>();
